...
void main() => runApp(const PetCareSignUpApp());

class PetCareSignUpApp extends StatelessWidget {
  const PetCareSignUpApp({super.key});
...
class _SignUpPawViewState extends State<SignUpPawView> with SingleTickerProviderStateMixin {
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          // Confirm password
          Text('Confirmar contraseña', style: TextStyle(color: Colors.blueGrey.shade700, fontWeight: FontWeight.w600)),
          const SizedBox(height: 6),
          TextFormField(
