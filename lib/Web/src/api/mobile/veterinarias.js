const db = require('../../../config/db'); // instancia única de Knex

// GET /api/mobile/veterinarias
async function listVeterinarias(req, res) {
  try {
    // 1) Traer veterinarias con coordenadas (para el mapa)
    ...
    // 2) Traer servicios activos de todas en un solo query
    ...
    // 3) Mapear servicios por veterinaria
