...
// 📋 OBTENER VETERINARIAS PENDIENTES (Admin)
...
// 🔍 OBTENER DETALLE DE VETERINARIA (Admin)
...
// ✏️ ACTUALIZAR ESTADO DE VERIFICACIÓN (Admin: Aprobar/Rechazar)
router.put('/estado/:id', async (req, res) => {
    ...
    try {
        ...
        // Si se aprueba, limpiamos el motivo de rechazo
        // Si se rechaza, guardamos el motivo (pero VeterinariasMaestra no tiene columna motivo_rechazo)
        // Podemos usar el campo 'referencias' o crear una nueva columna

        if (nuevoEstado === 'Rechazada' && motivo) {
            // Opción 1: Agregar columna motivo_rechazo a VeterinariasMaestra
            // Opción 2: Guardar en campo notas o referencias temporalmente
...
// 🆕 OBTENER ÚLTIMA VETERINARIA REGISTRADA (Para confirmar registro)
...
// 📂 OBTENER VETERINARIAS DE UN PROPIETARIO (Mis Veterinarias)
...
// ✏️ ACTUALIZAR VETERINARIA (Edición completa)
